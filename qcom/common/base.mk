...
#yihang hanxiaoming 2015.8.13 add for beidou begin
BEIDOU_HARDWARE += beidou.default
#yihang hanxiaoming 2015.8.13 add for beidou end
...
PRODUCT_PACKAGES += getaplog  \
                    ...
                    tcpdump  \
                    getlogapk 
# modified for qrt get log by xuegang 20150819 end
...
MICRONET_PACKAGES += testframe_prot
...
#yihang hanxiaoming 2015.8.13 add for beidou begin
PRODUCT_PACKAGES += $(BEIDOU_HARDWARE)
#yihang hanxiaoming 2015.8.13 add for beidou end
